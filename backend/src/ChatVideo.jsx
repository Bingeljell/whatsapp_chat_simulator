...
export const ChatVideo = ({ script, participants, chatName }) => { 
    ...
    // Default data if script is empty
    ...
    // --- SCALING LOGIC ---
    // We design for a fixed "Mobile" width of 400px.
    // We scale this up to fit the actual render width (e.g. 1080px).
    const BASE_WIDTH = 400; 
    const scale = width / BASE_WIDTH;
    
    // We calculate the required inner height so that when scaled up, it fills the render height exactly.
    // e.g. 1920 / 2.7 = 711px. 
