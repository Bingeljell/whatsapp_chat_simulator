...
function App() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100 overflow-hidden max-w-md mx-auto shadow-2xl border-x border-gray-300">
      {/* Header */}
      <header className="bg-whatsapp-green-dark p-3 flex items-center justify-between shadow-md text-white">
      ...
      {/* Main Content Area */}
      <main className="flex-1 p-0 bg-whatsapp-bg flex flex-col overflow-hidden relative">
        {!showChat ? (
